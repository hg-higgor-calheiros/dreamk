...
const style = StyleSheet.create({
  ...
  w9_10: { width: "90%" },
  wFull: { width: "100%" },
  textBorder: { textShadowColor: '#0005', textShadowOffset: { width: 1, height: 1}, textShadowRadius: 1 }
});
...
export const textBold = style.textBold;
